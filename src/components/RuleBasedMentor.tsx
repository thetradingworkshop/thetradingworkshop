  ...
  return (
    <Card className={`p-5 border-slate-800 bg-slate-950 text-slate-200 ${className}`}>
      <div className="flex items-center space-x-2 mb-5 border-b border-slate-800 pb-3">
        ...
        <h3 className="text-base font-black uppercase tracking-widest text-slate-400">Hard-Rule Analysis</h3>
      </div>
      ...
      <div className="space-y-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm font-black uppercase tracking-widest text-emerald-500/70">Strengths</span>
            </div>
            <div className="space-y-1">
              {insight.strengths.map((strength, index) => (
                <p key={index} className="text-lg font-medium text-slate-300 leading-snug">
                  {strength}
                </p>
              ))}
            </div>
          ...
          <div className="space-y-2">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm font-black uppercase tracking-widest text-rose-500/70">Weaknesses</span>
            </div>
            <div className="space-y-1">
        ...
        <div className="pt-4 border-t border-slate-800">
          <div className="flex items-center space-x-2 mb-2">
            ...
            <span className="text-sm font-black uppercase tracking-widest text-amber-500/70">Next Action</span>
          </div>
